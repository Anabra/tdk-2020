...
\begin{frame}
	\frametitle{Valódi points-to elemzés Datalog-ban}
    \begin{mathpar}
	\InferRule{\Store{p}{n}}
	{\Heap{p}{n}}
	{H-Store}
...
\begin{center}
	...
	\begin{minipage}{0.475\textwidth}
		\begin{tcolorbox}[tab2,tabularx={l|r}]
			...
			\pilcode{xs}  & $Nil[\dots], Cons[\dots]$ \\\hline
			\pilcode{ys}  & $Nil[\dots], Cons[\dots]$ \\\hline\hline
...
\begin{frame}[fragile]
\frametitle{Élőségi elemzés forrásai}
	\begin{mathpar}
...
\begin{frame}[fragile]
	\frametitle{Élőségi elemzés egyéb szabályai (részlet)}
	\begin{mathpar}
	\DatalogRule{\LiveSVal{x}}
	{\LiveSVal{y} \\\\
		\Move{y}{x}}
