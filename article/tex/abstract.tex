...
\begin{document}
	\begin{abstract}
		...
		Our goal is to provide a full-fledged implementation of GRIN by combining the currently available best technologies like LLVM and Soufflé, and evaluate the framework's effectiveness by measuring how the optimizer improves the performance of certain programs. We also present some improvements to the already existing components of the framework like a Datalog-compatible syntax specification of the intermediate representation, the Datalog based formalization of the created-by and liveness analyses, and the specification of an extended version of the dead data elimination optimization.
